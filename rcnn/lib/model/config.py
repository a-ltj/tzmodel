...
__C.TRAIN.STEPSIZE = [30000]		#之前是30000
...
__C.TRAIN.TRUNCATED = True			#False

# Whether to have weight decay on bias as well
__C.TRAIN.BIAS_DECAY = False			#False
...
__C.TRAIN.USE_FLIPPED = True			#水平翻转 
...
__C.TRAIN.SNAPSHOT_ITERS = 10000		#5000
...
# Total number of examples			#感觉这个地方可以改下
...
__C.ANCHOR_RATIOS = [0.5,1,2]		#[0.3,0.5,1,2,3]   0.2 0.25
