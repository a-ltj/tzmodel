...
from label.crnn.config import global_config
from label.crnn.local_utils import establish_char_dict
from label.crnn.data_provider import tf_io_pipline_fast_tools
